...
hook Sstore SafeL2Harness.(slot 0) address newSingletonAddress {
...
hook Sstore SafeL2Harness.(slot 24440054405305269366569402256811496959409073762505157381672968839269610695612) address newSingletonAddress {
    ghostSingletonAddress = newSingletonAddress;
}
...
// converted to decimal because certora doesn't seem to support hex yet.
hook Sstore SafeL2Harness.(slot 49122629484629529244014240937346711770925847994644146912111677022347558721749) address newFallbackHandlerAddress {
